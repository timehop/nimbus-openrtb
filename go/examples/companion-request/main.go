	...
	bidRequest := twofive.Request{
		...
		Imp: []twofive.Imp{
			twofive.Imp{
				...
				Video: &twofive.Video{
					CompanionAd: []twofive.Banner{ // concurrent example
						{
							W:   320,
							H:   50,
							Vcm: 0,
					...
					CompanionType: []int{1, 2, 3}, // Static Resource, HTML Resource, and iframe Resource allowed
					Mimes:         []string{"video/mp4", "video/webm", "video/3gpp"},
					MinBitRate:    1,
					MaxBitRate:    200000,
					API:           []int{2, 3},
					Pos:           1,
